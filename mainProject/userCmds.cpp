...
void myFuncs::cmdHelp(std::istream& in, std::ostream& out)
{
    if (in.get() != '\n')
    {
...
void myFuncs::cmdCreate(std::istream& in, std::ostream& out, std::map< std::string, storage_t >& depot, std::string dest)
{
    std::string file = "";
    in >> file;
    if (!file.empty())
    {
        ...
        if (fileIn.is_open())
        {
            ...
            tempoStorage = myFuncs::readStorage(fileIn);
...
void myFuncs::cmdChoose(std::istream& in, std::ostream& out, std::map< std::string, storage_t >& depot, std::string& storage)
{
    std::string chName = "";
    in >> chName;
    if (!in)
...
void myFuncs::cmdDelete(std::istream& in, std::ostream& out, std::map< std::string, storage_t >& depot)
{
    std::string tempoS = "";
    in >> tempoS;
...
void myFuncs::cmdList(std::ostream& out, std::map< std::string, storage_t >& depot)
{
...
void myFuncs::cmdShow(std::istream& in, std::ostream& out, std::map< std::string, storage_t >& depot)
{
    std::string tempoS = "";
    in >> tempoS;
...
void myFuncs::cmdRename(std::istream& in, std::ostream& out, std::map< std::string, storage_t >& depot)
{
    std::string name = "";
    std::string newName = "";
    in >> name >> newName;
...
void myFuncs::cmdSave(std::istream& in, std::ostream& out, std::map< std::string, storage_t >& depot)
{
    std::string dest = "";
    in >> dest;
...
void myFuncs::cmdPrint(std::istream& in, std::ostream& out, std::map<std::string, storage_t>& depot, std::string& storage)
{
...
void myFuncs::cmdFono(std::istream& in, std::ostream& out)
{
    std::string word = "";
    in >> word;
    if (!in)
    ...
    bool softFact = false;
    std::string vowels = "¸óåûàîýÿèþ";
    std::string cons = "éöêíãøùçõôâïðëäæ÷ñìòá";
    std::string other = "úü";
    std::string transc = "[]";
    for (int let : word)
    {
...
void myFuncs::cmdMakeSent(std::istream& in, std::ostream& out, std::map<std::string, storage_t>& depot, std::string& storage)
{
    size_t usNum = 0;
    in >> usNum;
    if (!in)
